...
import { Label, Modal, ModalBody, UncontrolledTooltip } from 'reactstrap';
import { sendEmailPdfRequest } from "../../../store/UtilityCallFunction/slice";
...
export const Terms = ({ props }) => {
    ...
    const shareEmailHandle = () => {
        dispatch(sendEmailPdfRequest(values?.email))
    }
            ...
            <Modal className='modal-lg detailsModal' isOpen={values?.isTermsAndConditionClick} >
                ...
                <ModalBody className="wflexLayout p-0">
                    <div className='wflexScroll mb-3'>
                        <div className='p-4'>
                            <div className="wflexScroll" style={{ fontSize: "13px" }}>
                                {/* <div className="mb-4">
                    <img src={alfredlogo} alt="" width="150" />
                                ...
                                <p className="ps-4">If you have any questions about these Terms, please contact us at <strong>support@helloalfred.ai</strong></p>
                            </div>
                        </div>
                    </div>
                    <div className="px-4">
