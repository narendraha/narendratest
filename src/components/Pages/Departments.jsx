  ...
  return (
    <>
      <BannerSectionStyle5
        ...
        title="Get to Know <br>Alfred Departments"
        subTitle="At Alfred, we offer a wide range of medical and healthcare services that are designed to meet your individual needs and help you achieve optimal health."
      />
